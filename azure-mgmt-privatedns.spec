...
License  : MIT
Requires: azure-mgmt-privatedns-python = %{version}-%{release}
Requires: azure-mgmt-privatedns-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-privatedns package.
Group: Default
Requires: azure-mgmt-privatedns-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-privatedns package.


%package python3
Summary: python3 components for the azure-mgmt-privatedns package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_privatedns)
Requires: pypi(azure_common)
Requires: pypi(msrest)
Requires: pypi(msrestazure)

%description python3
python3 components for the azure-mgmt-privatedns package.


%prep
%setup -q -n azure-mgmt-privatedns-0.1.0
cd %{_builddir}/azure-mgmt-privatedns-0.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588793338
